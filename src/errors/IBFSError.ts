...
const errorCodes = {
    ...
    L1_FG_READ_STREAM:              'Failed to create a read stream for a file descriptor.',
    L1_FG_READ_STREAM_BUFFER:       'An error occurred while buffering the read stream.',
    L1_FG_READ_STREAM_OUTRANGE:     'The read stream is out of range or the range specified is invalid.',
